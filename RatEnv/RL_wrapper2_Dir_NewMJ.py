...
class RatRL(gym.Env):
    ...
    def reset(self):
        ...
        self.pos = list(self.data.sensordata[16:16 + 3])  # com_pos from imu  # imu_pos
    ...
    def step(self, action, Render=False, LegCal=False):
        ...
        self.pos = list(self.data.sensordata[16:16+3].copy())  # com_pos from imu  # imu_pos  list()  or addr dependence
        self.quat = list(self.data.sensordata[19:19 + 4].copy())
        self.vel = list(self.data.sensordata[23:23 + 3].copy())
        self.acc = list(self.data.sensordata[26:26 + 3].copy())
        self.gyro = list(self.data.sensordata[29:29 + 3].copy())
