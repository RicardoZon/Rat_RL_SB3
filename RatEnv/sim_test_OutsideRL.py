...
if __name__ == '__main__':
    ...
    for i in range(RUN_STEPS):
        ...
        RatEnv.theMouse.runStep(ctrlData, render=True, legposcal=True)
    ...
    # Record.savePath2("imu_record_Plane_1223")
    # Record.savePath2("imu_record_Plane_Prio", RatEnv.theMouse, SELFINFO=True)
    ProcessYH(RatEnv)  # Plot
